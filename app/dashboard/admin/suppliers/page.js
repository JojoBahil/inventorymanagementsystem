...
export default function SuppliersAdmin() {
  ...
  return (
    <div className="w-[93%] mx-auto space-y-8">
      ...
      <div>
        <h1 className="text-4xl md:text-5xl font-bold text-primary tracking-tight mb-1">Suppliers</h1>
        <p className="text-secondary text-lg md:text-xl">Add or edit supplier companies.</p>
      </div>
